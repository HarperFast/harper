...
async function lmdbCreateRecords(insert_obj) {
    try {
        ...
        let lmdb_response = await lmdb_insert_records(environment, schema_table.hash_attribute, attributes, insert_obj.records, insert_obj[hdb_terms.CLUSTERING_FLAG] !== true);
