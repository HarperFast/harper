...
import {
	applyRuntimeEnvConfig as _applyRuntimeEnvConfig,
	hasPersistedEnvConfigState as _hasPersistedEnvConfigState,
} from './harperConfigEnvVars.ts';
const applyRuntimeEnvConfig = _applyRuntimeEnvConfig;
const hasPersistedEnvConfigState = _hasPersistedEnvConfigState;
...
var BACKUP_ERR = 'Error backing up config file';
var EMPTY_GET_VALUE = 'Empty parameter sent to getConfigValue';
var DEFAULT_CONFIG_FILE_PATH = path.join(PACKAGE_ROOT, 'static', hdbTerms.HDB_DEFAULT_CONFIG_FILE);

var CONFIGURE_SUCCESS_RESPONSE =
	'Configuration successfully set. You must restart Harper for new config settings to take effect.';

var DEPRECATED_CONFIG = {
...
export { initOldConfig };
export { getConfigFromFile };
export { getConfigFilePath };
export { addConfig };
export { deleteConfigFromFile };
export { getConfigObj };
export { resolvePath };
export { getFlatConfigObj };
...
var PRESERVED_PROPERTIES = ['databases'];
/**
