...
export function checkValidTable(propertyName: string, value: string): string {
...
export function validateSchemaExists(value: string, helpers: Joi.CustomHelpers): any {
...
export function validateTableExists(value: string, helpers: Joi.CustomHelpers): any {
...
export function validateSchemaName(value: string, helpers: Joi.CustomHelpers): any {
