...
module.exports = function (search_object, type) {
    switch (type) {
        case 'hash':
            return validator.validateObject(search_object, search_by_hash_constraints);
        case 'value':
            return validator.validateObject(search_object, search_by_value_constraints);
        case 'hashes':
            return validator.validateObject(search_object, search_by_hashes_constraints);
        case 'conditions':
            return validator.validateObject(search_object, search_by_conditions);
    }
