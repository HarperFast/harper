...
export function addUserValidation(object: any): Error | undefined {
...
export function alterUserValidation(object: any): Error | undefined {
...
export function dropUserValidation(object: any): Error | undefined {
	constraints.password.presence = false;
	constraints.username.presence = true;
	constraints.role.presence = false;
	constraints.active.presence = false;
