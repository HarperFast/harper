...
//
// Its own module because bin/harper.ts imports it first: under ESM a module's dependencies are
// evaluated before its own body, so inlining this there would run it last.
