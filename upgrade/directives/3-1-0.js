...
function updateSettingsFile_3_1_0() {
    ...
    let new_hdb_settings_vals = `   ;Settings for the HarperDB process.\n` +
        ...
        `${HDB_SETTINGS_NAMES.SERVER_PORT_KEY} = ${getOldPropsValue(HDB_SETTINGS_NAMES.SERVER_PORT_KEY)}\n` +
        `   ;Set to true to enable HTTPS on the HarperDB REST endpoint.  Requires a valid certificate and key.\n` +
        `${HDB_SETTINGS_NAMES.HTTP_SECURE_ENABLED_KEY} = ${getOldPropsValue(HDB_SETTINGS_NAMES.HTTP_SECURE_ENABLED_KEY)}\n` +
