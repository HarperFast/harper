...
- Can be deferred: Yes by setting `nativePlane: false` per index or `HNSW_NO_NATIVE_DEFAULT=1` before declaring new indexes. An explicitly enabled or persisted native index returns 503 and retries rebuild when the module is unavailable.
