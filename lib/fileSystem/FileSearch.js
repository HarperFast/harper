...
class FileSearch{
    ...
    [getAttributeValues](callback){
        ...
        let select_columns = this[getColumns](this.statement.columns);

        columns = columns.concat(this[getColumns](this.statement.joins));
        columns = columns.concat(this[getColumns](this.statement.where));

        let found_columns = [];
        columns.forEach((column)=>{
            found_columns.push(this[findColumn](column));
        });
