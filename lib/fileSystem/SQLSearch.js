...
/**
 * Test Queries
 * 1. Test getFetchAttributeValues getting default hash attribute
 * "sql":"select weight_lbs, age, owner_name from dev."
 * 2. Test exact search values
 * "sql":"select weight_lbs, age, owner_name from dev.dog where owner_name = 'Kyle'"
 * 3. Test fetching non hash attribute
 * "sql":"select weight_lbs, age, owner_name from dev.dog where owner_name = 'Kyle' order by age
 */
