...
// difference. Anything reachable by some other path is untouchable by construction, and
// the removed set is derived rather than a hardcoded list of directory names that would
// silently rot as alasql's tree shifts.
//
...
// react-native-fs edge, so anything only reachable through it never gets marked.
