...
describe('Test jobs.js', () => {
    ...
    describe('Test addJob', function() {
        ...
        beforeEach(function() {
            ...
            jobs.__set__('p_search_by_value', p_search_by_value_stub);
            jobs.__set__('p_insert', p_insert_stub);
        });
    ...
    describe('Test getJobsInDateRange', function() {
        ...
        it('test custom error message is thrown', async () => {
            ...
            test_job.from_date = '2017-02-01';
            test_job.to_date = '2018-07-07';
            await test_util.assertErrorAsync(getJobsInDateRange, [test_job], new Error(`there was an error searching for jobs.  Please check the log for details.`));
        });
    });
