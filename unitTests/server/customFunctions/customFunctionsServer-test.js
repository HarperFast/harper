...
describe('Test customFunctionsServer module', () => {
  ...
  describe('Test customFunctionsServer function', () => {
    ...
    it('should build HTTPS server instance with started and listening state equal to true', async () => {
      ...
      const state_key = Object.getOwnPropertySymbols(server).find((
  ...
  describe('buildRoutes() method', () => {
    ...
    it('should call buildRoutes', async () => {
      ...
      const plugins_array = Object.getOwnPropertySymbols(server[plugin_key][0]).find((s => String(s) === 'Symbol(fastify.pluginNameChain)'));
    ...
    it('should find the appropriate route files in the test project', async () => {
      ...
      const plugin_key = Object.getOwnPropertySymbols(server).find((s => String(s) === 'Symbol(fastify.children)'));
      const children = Object.getOwnPropertySymbols(server[plugin_key][0]).find((s => String(s) === 'Symbol(fastify.children)'));
      const route_files = Object.getOwnPropertySymbols(server[plugin_key][0][children][0]).find((s => String(s) === 'Symbol(fastify.pluginNameChain)'));
