...
describe('Test operationsValidation module', () => {
    ...
    describe('Test getDropCustomFunctionValidator function', () => {
        ...
        it('Test validation messages are returned', () => {
            ...
            expect(result.message).to.equal("'project' is not allowed to be empty. 'type' must be one of [helpers, routes]. 'type' is not allowed to be empty. 'file' is not allowed to be empty");
        });
    ...
    describe('Test setCustomFunctionValidator function', () => {
        ...
        it('Test validation messages are returned', () => {
            ...
            expect(result.message).to.equal("'project' is not allowed to be empty. 'type' must be one of [helpers, routes]. 'type' is not allowed to be empty. 'file' is not allowed to be empty. 'function_content' is not allowed to be empty");
        });
