...
//         let runUpgradeDirectives = upgrade_rw.__get__('runUpgradeDirectives');
...
//         it('test runUpgradeDirectives', function () {
//             runUpgradeDirectives('1.1.0', '2.1.0');
//         });
//     });
//
...
//         let runUpgradeDirectives_stub = undefined;
//         let chmodSync_stub = undefined;
//
//         let runUpgradeDirectives_orig = upgrade_rw.__get__('runUpgradeDirectives');
//
//         let spinner = upgrade_rw.__get__('countdown');
...
//             runUpgradeDirectives_stub = sandbox.stub().returns(['result 1', 'result 2']);
//             chmodSync_stub = sandbox.stub(fs, 'chmodSync').returns('');
//
//             upgrade_rw.__set__('runUpgradeDirectives', runUpgradeDirectives_stub);
//         });
//
//         afterEach(function () {
//             sandbox.restore();
//             upgrade_rw.__set__('runUpgradeDirectives', runUpgradeDirectives_orig);
//             spinner.stop();
//         });
//
...
//         });
//
//         //TODO - update test to make sure we are still checking the right thing
//         it('test startUpgrade with runUpgradeDirectives_stub Exception', async function () {
//             let exep = undefined;
//             try {
//                 runUpgradeDirectives_stub = sandbox.stub().throws(new Error('runUpgradeDirectives_stub Test Error'));
//                 upgrade_rw.__set__('runUpgradeDirectives', runUpgradeDirectives_stub);
//                 await startUpgrade('1.1.0');
//             } catch (e) {
//                 exep = e;
