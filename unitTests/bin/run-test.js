...
describe('Test run module', () => {
    ...
    describe('Test openCreateTransactionEnvironment function', () => {
        ...
        it('Test openCreateTransactionEnvironment sad path', async () => {
            ...
            expect(log_error_stub.getCall(0).firstArg).to.equal('Unable to create the transaction environment for unit_tests.are_amazing, due to: I am a unit test error test');
        });
    });
    ...
    describe('Test isHdbInstalled function', () => {
        ...
        it('Test non ENOENT error is handled as expected', async () => {
            ...
            expect(log_error_stub.getCall(0).firstArg).to.equal('Error checking for HDB install - Error: I am a unit test error test');
        });
    });
