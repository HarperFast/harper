...
const SETTINGS_TO_IGNORE = ['settings_path', 'install_user', 'LOGGER'];
const SETTINGS_PATH = getSettingsFilePath();
let directive3_2_0;
let updateSettingsFile_3_2_0;

describe('Test 3.2.0 Upgrade Directive', () => {
    const sandbox = sinon.createSandbox();

    before(() => {
        test_util.preTestPrep();
        directive3_2_0 = rewire('../../../upgrade/directives/3-2-0')[0];
        updateSettingsFile_3_2_0 = directive3_2_0.sync_functions[0];
    });
    ...
    describe('Test updateSettingsFile_3_2_0 function', () => {
        ...
        it('Test new setting file has all hdb settings including new custom function ones', () => {
            const result = updateSettingsFile_3_2_0();
            ...
            expect(result).to.equal('New settings file for 3.2.0 upgrade successfully created.');
        ...
        it('Test error from backup is logged and thrown', () => {
            ...
            test_util.assertErrorSync(updateSettingsFile_3_2_0, [], new Error('Error with backup'));
        ...
        it('Test error from writing new setting file is logged and thrown', () => {
            ...
            test_util.assertErrorSync(updateSettingsFile_3_2_0, [], new Error('Error writing new file'));
