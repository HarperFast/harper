...
const DBIDefinition = require('../../../../upgrade/lmdb/nodeLMDB/DBIDefinition');
const lmdb_env_util = require('../../../../upgrade/lmdb/nodeLMDB/environmentUtility');
const rewire = require('rewire');
const rw_lmdb_env_util = rewire('../../../../upgrade/lmdb/nodeLMDB/environmentUtility');
const assert = require('assert');
const path = require('path');
const test_utils = require('../../../test_utils');
const fs = require('fs-extra');
const LMDB_TEST_ERRORS = require('../../../commonTestErrors').LMDB_ERRORS_ENUM;
const lmdb_terms = require('../../../../upgrade/lmdb/nodeLMDB/terms');
...
describe("Test LMDB environmentUtility module", ()=>{
    ...
    describe("Test createEnvironment function", ()=>{
        ...
        it('call function happy path', async ()=>{
            ...
            await test_utils.assertErrorAsync(fs.access, [path.join(BASE_TEST_PATH, TEST_ENVIRONMENT_NAME, 'data.mdb')], undefined, 'test path exists');

            assert.notDeepStrictEqual(global.old_lmdb_map, undefined);
            assert.notDeepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME], undefined);
    ...
    describe("Test openEnvironment function", ()=> {
        ...
        it('happy path test', async ()=>{
            ...
            assert.notDeepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME], undefined);
            assert.deepStrictEqual(env, global.old_lmdb_map[CACHED_ENV_NAME]);
            assert.deepStrictEqual(env[lmdb_terms.ENVIRONMENT_NAME_KEY], 'lmdbTest.test');
    ...
    describe("Test deleteEnvironment function", ()=> {
        ...
        it('happy path', async ()=>{
            ...
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME], undefined);
        });
    });
    ...
    describe("Test createDBI function", ()=> {
        ...
        it('call function happy path', async ()=>{
            ...
            assert.notDeepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME], undefined);
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME], dbi);

            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME][lmdb_terms.DBI_DEFINITION_NAME], new DBIDefinition(false, lmdb_terms.DBI_KEY_TYPES.STRING, true));
        });
        ...
        it('call function with dup_sort = true', async ()=>{
            ...
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME][lmdb_terms.DBI_DEFINITION_NAME], new DBIDefinition(true, lmdb_terms.DBI_KEY_TYPES.STRING, false));
        ...
        it('call function with dup_key & key_type = NUMBER', async ()=>{
            ...
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME][lmdb_terms.DBI_DEFINITION_NAME], new DBIDefinition(true, lmdb_terms.DBI_KEY_TYPES.NUMBER));
            let dbi_def = await test_utils.assertErrorAsync(get_dbi_definition, [env, ID_DBI_NAME], undefined);
        ...
        it('call function with dup_key = false & key_type = NUMBER', async ()=>{
            ...
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME][lmdb_terms.DBI_DEFINITION_NAME], new DBIDefinition(false, lmdb_terms.DBI_KEY_TYPES.NUMBER));
            let dbi_def = await test_utils.assertErrorAsync(get_dbi_definition, [env, ID_DBI_NAME], undefined);
        ...
        it('call function with dup_key = false & key_type = STRING', async ()=>{
            ...
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME][lmdb_terms.DBI_DEFINITION_NAME], new DBIDefinition(false, lmdb_terms.DBI_KEY_TYPES.STRING));
        ...
        it('call function on existing dbi', async ()=>{
            ...
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME][lmdb_terms.DBI_DEFINITION_NAME], new DBIDefinition(true, lmdb_terms.DBI_KEY_TYPES.STRING));
    ...
    describe("Test listDBIDefinitions function", ()=> {
        ...
        it('call function happy path', async ()=>{
            ...
            expected.id = new DBIDefinition(true, lmdb_terms.DBI_KEY_TYPES.STRING, false);
    ...
    describe("Test dropDBI function", ()=> {
        ...
        it('call function happy path', async ()=>{
            ...
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME], undefined);
            assert.deepStrictEqual(global.old_lmdb_map[CACHED_ENV_NAME].dbis[ID_DBI_NAME], dbi);
