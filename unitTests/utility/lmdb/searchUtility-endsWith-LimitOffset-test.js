...
describe('test endsWith function', ()=> {
    ...
    it("test validation", () => {
        ...
        test_utils.assertErrorSync(search_util.endsWith, [transaction], LMDB_TEST_ERRORS.ATTRIBUTE_REQUIRED, 'no hash attribute');
        test_utils.assertErrorSync(search_util.endsWith, [transaction,'id', 'city'], LMDB_TEST_ERRORS.SEARCH_VALUE_REQUIRED, 'no search_value');
    ...
    it("test search on attribute no exist", () => {
        let results = test_utils.assertErrorSync(search_util.endsWith,[transaction, 'id','fake', 'bad'], LMDB_TEST_ERRORS.DBI_DOES_NOT_EXIST);
...
describe('test endsWith function reverse limit offset', ()=> {
    ...
    it("test search on first_name reverse", () => {
        let expected = [467,901,314,186,508,922,151,450,692,62,936,871,425,685,268,968,625,301,19,538,795,621,876,898,545,270,669];
