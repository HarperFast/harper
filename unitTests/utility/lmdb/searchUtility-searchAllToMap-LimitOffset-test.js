...
describe('test searchAllToMap function', ()=> {
    ...
    it("searchAllToMap rows limit 100", ()=>{
        let rows = test_utils.assertErrorSync(search_util.searchAllToMap, [transaction, HASH_ATTRIBUTE_NAME, PERSON_ATTRIBUTES, false, 100], undefined, 'search');
    ...
    it("searchAllToMap rows limit 20 offset 100" , ()=>{
        let rows = test_utils.assertErrorSync(search_util.searchAllToMap, [transaction, HASH_ATTRIBUTE_NAME, PERSON_ATTRIBUTES, false, 20, 100], undefined, 'search');
    ...
    it("searchAllToMap rows reverse limit 100", ()=>{
        let rows = test_utils.assertErrorSync(search_util.searchAllToMap, [transaction, HASH_ATTRIBUTE_NAME, PERSON_ATTRIBUTES, true, 100], undefined, 'search');
    ...
    it("searchAllToMap rows reverse limit 20 offset 100" , ()=>{
        let rows = test_utils.assertErrorSync(search_util.searchAllToMap, [transaction, HASH_ATTRIBUTE_NAME, PERSON_ATTRIBUTES, true, 20, 100], undefined, 'search');
