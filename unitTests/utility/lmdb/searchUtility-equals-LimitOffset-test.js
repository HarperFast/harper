...
describe('test equals function', ()=> {
    ...
    it("test validation", () => {
        ...
        test_utils.assertErrorSync(search_util.equals, [transaction], LMDB_TEST_ERRORS.ATTRIBUTE_REQUIRED, 'no hash attribute');
        test_utils.assertErrorSync(search_util.equals, [transaction, 'id', 'city'], LMDB_TEST_ERRORS.SEARCH_VALUE_REQUIRED, 'no search_value');
    ...
    it("test search on attribute no exist", () => {
        let results = test_utils.assertErrorSync(search_util.equals, [transaction, 'id', 'fake', 'bad'], LMDB_TEST_ERRORS.DBI_DOES_NOT_EXIST);
