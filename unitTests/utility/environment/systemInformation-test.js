...
const EXPECTED_PROPERTIES = {
    ...
    cpu: [ "manufacturer", "brand", "vendor", "speed", "cores", "physicalCores", "processors", "cpu_speed", "current_load", "speedMin", "speedMax", "flags", "virtualization"],
        cpu_cpu_speed: ["min", "max", "avg", "cores"],
        cpu_current_load: ["avgLoad", "currentLoad", "currentLoadUser", "currentLoadSystem", "currentLoadNice", "currentLoadIdle", "currentLoadIrq", "rawCurrentLoad", "rawCurrentLoadUser", "rawCurrentLoadSystem", "rawCurrentLoadNice", "rawCurrentLoadIdle", "rawCurrentLoadIrq", "cpus"],
            cpu_current_load_cpus: ["load", "loadUser", "loadSystem", "loadNice", "loadIdle", "loadIrq", "rawLoad", "rawLoadUser", "rawLoadSystem", "rawLoadNice", "rawLoadIdle", "rawLoadIrq"],
