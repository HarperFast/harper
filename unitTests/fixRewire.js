 ...
 * alters the normal module wrapping code. The Node issue is:
 * https://github.com/nodejs/node/issues/43205
 * The perpetrator of this module modification is rewire. The equally crazy hack to fix this is to intercept this
 * alternate module wrapping that uses the vm script mechanism, and force every script to be pinned into memory. This is
