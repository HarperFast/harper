...
describe('Test functions from alasqlFunctionImporter w/ alasql', () => {
    ...
    it('should EXTRACT the correct date parts', () => {
        const generate_statement = (date_part) => `SELECT EXTRACT('${stub_timestamp}', '${date_part}') as [${date_part.toLowerCase()}_test_result]`;
    ...
    it('should return DATE_FORMAT() value in provided format', () => {
        const generate_statement = (date_format, key) => `SELECT DATE_FORMAT('${stub_timestamp}', '${date_format}') as [test_result_${key}]`;
    ...
    it('should return correct new date after time is added in DATE_ADD()', () => {
        const generate_statement = (value, interval) => `SELECT DATE_ADD('${stub_timestamp}', '${value}', '${interval}') as [test_result_${interval}]`;
    ...
    it('should return correct new date after time is subtracted in DATE_SUB()', () => {
        const generate_statement = (value, interval) => `SELECT DATE_SUB('${stub_timestamp}', '${value}', '${interval}') as [test_result_${interval}]`;
