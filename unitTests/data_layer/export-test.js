...
describe('Test export.js', () => {
    ...
    describe('Test export_local', function() {
        ...
        it('Test validation error is handled correctly', async () => {
            ...
            const expected_err = test_util.generateHDBError('format invalid. must be one of the following values: json, csv', 400);
    ...
    describe('Test saveToLocal', function() {
        ...
        it('Nominal case of saveToLocal with json', test_util.mochaAsyncWrapper(async function() {
            ...
            assert.equal(wrote_data, "Successfully exported JSON locally.", "Expected valid path");
        ...
        it('Nominal case of saveToLocal with csv', test_util.mochaAsyncWrapper(async function() {
            ...
            assert.equal(wrote_data, "Successfully exported CSV locally.", "Expected valid path");
            let stats = await p_fs_stat(file_name);
            assert.ok(stats, true, "Expected file to be found");
            let file = fs.readFileSync(file_name, 'utf-8');
            assert.ok(file.length > 0, "File was empty");
    ...
    describe('Test export_to_s3', function() {
        ...
        it('Nominal call export JSON to S3', async () => {
            const expected_body = "[{\"lastname\":\"Dog\",\"object\":null,\"array\":null,\"firstname\":\"Harper\",\"__createdtime__\":1618335194929,\"object_array\":null,\"__updatedtime__\":1618335194929,\"address\":\"1 North Street\",\"id\":\"8d9cd1b2-3e38-40cb-a340-c5d33e66dbb7\",\"one\":\"only one\"},{\"lastname\":null,\"object\":{\"name\":\"object\",\"number\":1,\"array\":[1,\"two\"]},\"array\":[1,2,\"three\"],\"firstname\":\"Harper\",\"__createdtime__\":1618335194930,\"object_array\":null,\"__updatedtime__\":1618335194930,\"address\":null,\"id\":\"bc56cf62-5ad1-4519-b1c6-26742b02e9d5\",\"one\":null},{\"lastname\":null,\"object\":null,\"array\":null,\"firstname\":null,\"__createdtime__\":1618335194930,\"object_array\":[{\"number\":1},{\"number\":\"two\",\"count\":2}],\"__updatedtime__\":1618335194930,\"address\":null,\"id\":\"dce07e2f-fa32-4ceb-b4a4-4270fefe51cf\",\"one\":null}]"
    ...
    describe('Test exportCoreValidation function', () => {
        ...
        it('Test search operation value wrong message returned', () => {
            ...
            const result = exportCoreValidation(export_obj);
            expect(result).to.equal('search_operation.operation must be one of the following values: search_by_value, search_by_hash, sql');
        });
    });
