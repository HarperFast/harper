...
const lmdb_search_by_hash = require('../../../../../data_layer/harperBridge/lmdbBridge/lmdbMethods/lmdbSearchByHash');
...
describe('Test lmdbGetDataByHash module', ()=>{
    ...
    describe('Test lmdbGetDataByHash function', ()=>{
        ...
        it('test finding multiple rows row, some attributes', async()=>{
            ...
            let expected_result = [{id:'10', height:145},{id:'8', height:undefined}];
