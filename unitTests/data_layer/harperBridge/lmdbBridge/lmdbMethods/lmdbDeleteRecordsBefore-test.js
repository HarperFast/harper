...
const delete_records_before = rewire('../../../../../data_layer/harperBridge/lmdbBridge/lmdbMethods/lmdbDeleteRecordsBefore');
...
describe('test validateDropSchema module', ()=>{
    ...
    describe('test methods', ()=>{
        ...
        it('Test error is thrown with no hash attribute', async()=>{
            ...
            await test_utils.assertErrorAsync(delete_records_before, [delete_before],
