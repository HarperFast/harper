...
describe('test lmdbSearch module', ()=>{
    ...
    describe('test executeSearch method', ()=>{
        ...
        it('test startswith on string reverse limit 10', async()=>{
            let expected = [ { "id": 140, "temperature": -2, "temperature_str": -2, "state": "DC", "city": "South Stewart" }, { "id": 193, "temperature": 28, "temperature_str": 28, "state": "IL", "city": "South Tony" }, { "id": 388, "temperature": 19, "temperature_str": 19, "state": "NV", "city": "South Vernshire" }, { "id": 538, "temperature": 40, "temperature_str": 40, "state": "MO", "city": "South Wavaborough" }, { "id": 613, "temperature": -5, "temperature_str": -5, "state": "SD", "city": "South Wellington" }, { "id": 680, "temperature": 65, "temperature_str": 65, "state": "ME", "city": "South Tess" }, { "id": 741, "temperature": 89, "temperature_str": 89, "state": "VT", "city": "South Wilbertfort" }, { "id": 762, "temperature": 36, "temperature_str": 36, "state": "NJ", "city": "South Stefaniestad" }, { "id": 904, "temperature": 66, "temperature_str": 66, "state": "MO", "city": "South Sammy" }, { "id": 951, "temperature": -9, "temperature_str": -9, "state": "SD", "city": "South Sigrid" } ];
        ...
        it('test lessthan offset 10', async()=>{
            let expected = [ { "id": 32, "temperature": -9, "temperature_str": -9, "state": "KY", "city": "Ferminmouth" }, { "id": 34, "temperature": -9, "temperature_str": -9, "state": "NJ", "city": "New Haydenbury" }, { "id": 45, "temperature": -9, "temperature_str": -9, "state": "IL", "city": "Port Jadyn" }, { "id": 218, "temperature": -9, "temperature_str": -9, "state": "OK", "city": "Claudiehaven" }, { "id": 307, "temperature": -10, "temperature_str": -10, "state": "MO", "city": "Maiastad" }, { "id": 479, "temperature": -10, "temperature_str": -10, "state": "IL", "city": "Tobychester" }, { "id": 517, "temperature": -10, "temperature_str": -10, "state": "ND", "city": "East Tremaine" }, { "id": 674, "temperature": -10, "temperature_str": -10, "state": "FL", "city": "South Cody" }, { "id": 860, "temperature": -10, "temperature_str": -10, "state": "IN", "city": "Gracemouth" }, { "id": 989, "temperature": -10, "temperature_str": -10, "state": "OR", "city": "Greenport" } ];
            let search_object = new SearchObject('dev', 'test', 'temperature', '25', 'id', ATTRIBUTES, undefined, false, 10);
        ...
        it('test lessthan offset 10 limit 10', async()=>{
            let expected = [ { "id": 25, "temperature": -7, "temperature_str": -7, "state": "NM", "city": "North Rosamondburgh" }, { "id": 371, "temperature": -8, "temperature_str": -8, "state": "IL", "city": "New Colten" }, { "id": 453, "temperature": -8, "temperature_str": -8, "state": "WI", "city": "Scottiefurt" }, { "id": 456, "temperature": -8, "temperature_str": -8, "state": "CT", "city": "North Jody" }, { "id": 675, "temperature": -9, "temperature_str": -9, "state": "NY", "city": "Julietborough" }, { "id": 689, "temperature": -8, "temperature_str": -8, "state": "OR", "city": "South Bennett" }, { "id": 699, "temperature": -9, "temperature_str": -9, "state": "HI", "city": "West Dock" }, { "id": 756, "temperature": -7, "temperature_str": -7, "state": "MD", "city": "Alexzanderport" }, { "id": 951, "temperature": -9, "temperature_str": -9, "state": "SD", "city": "South Sigrid" }, { "id": 998, "temperature": -9, "temperature_str": -9, "state": "CO", "city": "North Sally" } ];
            let search_object = new SearchObject('dev', 'test', 'temperature', '25', 'id', ATTRIBUTES, undefined, false, 10, 10);
            let results = await test_utils.assertErrorAsync(lmdb_search.executeSearch, [search_object, lmdb_terms.SEARCH_TYPES.LESS_THAN, HASH_ATTRIBUTE_NAME], undefined);
            assert.deepEqual(results.length, 10);
            assert.deepEqual(results, expected);
