...
describe(`Test schema validators `, function () {
	describe(`schema_object `, function () {
		it('Pass in object with valid schema name', function () {
			assert.equal(
				schema_validator.schema_object(test_schema_obj()),
				null,
				'Schema object validation should return null for valid schema names'
			);
		});
		...
		it('Pass in object with another valid schema name', function () {
			...
			assert.equal(
				schema_validator.schema_object(test_schema_obj(valid_schema)),
				null,
				'Schema object validation should return null for valid schema names'
			);
		});
		...
		it('Pass in object with invalid forward slash char in schema name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.schema,
				'Schema object validation should return schema validation error msg when a forward slash is included in schema name'
			);
		});
		...
		it('Pass in object with invalid backtick char in schema name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.schema,
				'Schema object validation should return schema validation error msg when a backtick is included in schema name'
			);
		});
	});
	...
	describe(`table_object`, function () {
		it('Pass in table_object with valid schema/table name values', function () {
			assert.equal(
				schema_validator.table_object(test_table_obj()),
				null,
				'Table object validation should return null for valid schema names'
			);
		});
		...
		it('Pass in object with another valid schema/table name', function () {
			const valid_table = '~!@#$%^&*()_+-=;:?,.<>';
			assert.equal(
				schema_validator.table_object(test_table_obj(valid_table)),
				null,
				'Schema object validation should return null for valid schema names'
			);
		});
		...
		it('Pass in object with no hash value included and expect no error msg', function () {
			...
			assert.equal(
				schema_validator.table_object(test_obj),
				null,
				'Table object validation should not require a hash value'
			);
		});
		...
		it('Pass in object with invalid forward slash char in table name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.table,
				'Table object validation should return schema validation error msg when a forward slash is included in schema name'
			);
		});
	...
	describe(`create_table_object`, function () {
		it('Pass in create_table_object with valid schema/table values', function () {
			assert.equal(
				schema_validator.create_table_object(test_table_obj()),
				null,
				'Create table object validation should return null for valid table names'
			);
		});
		...
		it('Pass in object with another valid schema/table name', function () {
			const valid_table = '~!@#$%^&*()_+-=;:?,.<>';
			assert.equal(
				schema_validator.create_table_object(test_table_obj(valid_table)),
				null,
				'Create table object validation should return null for valid table names'
			);
		});
		...
		it('Pass in object with invalid forward slash char in table name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.table,
				'Create table object validation should return table validation error msg when a forward slash is included in table name'
			);
		});
		...
		it('Pass in object with invalid backtick char in table name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.table,
				'Create table object validation should return table validation error msg when a backtick is included in table name'
			);
		});
		...
		it('Pass in object with invalid backtick char in hash attr name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.hash_attr,
				'Create table object validation should return hash attribute validation error msg when backticks are included in hash attribute name'
			);
		});
	});
	...
	describe(`attribute_object`, function () {
		it('Pass in attribute_object with valid schema/table/attribute value', function () {
			assert.equal(
				schema_validator.attribute_object(test_attribute_obj()),
				null,
				'Attribute object validation should return null for valid schema/table/attr names'
			);
		});
		...
		it('Pass in object with another valid schema/table/attr name', function () {
			const valid_name = '~!@#$%^&*()_+-=;:?,.<>';
			assert.equal(
				schema_validator.attribute_object(test_attribute_obj(valid_name, valid_name, valid_name)),
				null,
				'Attribute object validation should return null for valid schema/table/attr names'
			);
		});
		...
		it('Pass in object with invalid forward slash char in attr name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.attribute,
				'Attribute object validation should return attr validation error msg when a forward slash is included in attr name'
			);
		});
		...
		it('Pass in object with invalid backtick char in attr name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.attribute,
				'Attribute object validation should return attr validation error msg when a backtick is included in attr name'
			);
		});
		...
		it('Pass in object with invalid forward slash char in table name', function () {
			...
			assert.equal(
				test_result.message,
				expected_error_msgs.table,
				'Attribute object validation should return table validation error msg when a forward slash is included in table name'
			);
		});
	});
});
