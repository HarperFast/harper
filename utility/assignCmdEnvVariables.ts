...
export default assignCMDENVVariables;
 ...
 * @returns {{}}
 */
function assignCMDENVVariables(keys: string[] = [], isConfigParam = false): Record<string, string> {
	...
	let hdbSettings: Record<string, string> = {};
 ...
 * @returns {{}}
 */
function objKeysToLowerCase(obj: Record<string, any>): Record<string, any> {
	let key,
