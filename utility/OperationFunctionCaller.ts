 ...
 * @returns {Promise<{}>}
 */
export async function callOperationFunctionAsAwait(promisifiedFunction: (arg: any) => Promise<any>, functionInput: any, followupAsyncFunc: ((arg1: any, arg2: any) => Promise<any>) | null): Promise<any> {
