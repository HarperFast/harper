...
function generateLicense(license_object) {
    try {
        ...
        let obj = new License(moment(license_object.exp_date).unix(), license_object.storage_type, license_object.api_call, license_object.version, license_object.fingerprint);
