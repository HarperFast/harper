...
files=( "dataLayer" "sqlTranslator" "validation" "security" "utility" "utility/install" "utility/logging" "utility/functions" "utility/functions/date" "utility/functions/math" "utility/functions/string" "utility/functions/sql" "utility/registration" "lib/fileSystem" "lib/server" "lib/streams" "server" "server/clustering" "json" )
...
harperdb_run()
{
	...
	if [ "$theProc" ]; then
		 apiKey="fe1dfb2c3647474f8f3e9d836783e694"
               ...
               #POSTMAN: HarperDB Integration Tests CI
