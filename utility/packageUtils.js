/**
 * This file is used to determine the package root of this repo, and is used
 * throughout the source code. This cannot be converted to TypeScript until we
 * can remove the `/bin/dev.js` script since that script relies on this file.
 */
...
function findPackageJson() {
	const MAX = 10;
	let dir = __dirname, filePath, i = 0;
