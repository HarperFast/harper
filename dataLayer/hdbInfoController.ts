 ...
 */
export async function insertHdbInstallInfo(newVersionString: string): Promise<any> {
 ...
 */
export async function insertHdbUpgradeInfo(newVersionString: string): Promise<any> {
	let newInfoRecord;
 ...
 * @returns {Promise<[]>}
 */
async function getAllHdbInfoRecords(): Promise<any[]> {
 ...
 */
async function getLatestHdbInfoRecord(): Promise<any> {
	let versionData = await getAllHdbInfoRecords();
 ...
 */
export async function getVersionUpdateInfo(): Promise<UpgradeObject | undefined> {
 ...
 */
function checkIfInstallIsSupported(dataVNum: string) {
	const errMsg =
