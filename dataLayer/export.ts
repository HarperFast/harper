 ...
 * @param exportObject
 */
async function export_local(exportObject: any): Promise<any> {
	hdbLogger.trace(
 ...
 * @param directoryPath
 */
async function confirmPath(directoryPath: string): Promise<boolean> {
 ...
 * @param data
 */
async function saveToLocal(filePath: string, sourceDataFormat: string, data: any): Promise<any> {
 ...
 * @returns {*}
 */
async function export_to_s3(exportObject: any): Promise<any> {
 ...
 * @returns {string}
 */
function exportCoreValidation(exportObject: any): string | undefined {
 ...
 * @param exportObject
 */
async function getRecords(exportObject: any): Promise<any> {
