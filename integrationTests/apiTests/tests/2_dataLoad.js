...
describe('2. Data Load', () => {
    ...
    it('1 Upload Suppliers.csv',  () => {
        return csvFileUpload(testData.schema, testData.supp_tb,
            getCsvPath() + 'Suppliers.csv');
    });

    it('2 Upload Region.csv',  () => {
        return csvFileUpload(testData.schema, testData.regi_tb,
            getCsvPath() + 'Region.csv');
    });

    it('3 Upload Territories.csv',  () => {
        return csvFileUpload(testData.schema, testData.terr_tb,
            getCsvPath() + 'Territories.csv');
    });

    it('4 Upload EmployeeTerritories.csv',  () => {
        return csvFileUpload(testData.schema, testData.empt_tb,
            getCsvPath() + 'EmployeeTerritories.csv');
    });

    it('5 Upload Shippers.csv',  () => {
        return csvFileUpload(testData.schema, testData.ship_tb,
            getCsvPath() + 'Shippers.csv');
    });

    it('6 Upload Categories.csv',  () => {
        return csvFileUpload(testData.schema, testData.cate_tb,
            getCsvPath() + 'Categories.csv');
    });

    it('7 Upload Employees.csv',  () => {
        return csvFileUpload(testData.schema, testData.emps_tb,
            getCsvPath() + 'Employees.csv');
    });

    it('8 Upload Customers.csv',  () => {
        return csvFileUpload(testData.schema, testData.cust_tb,
            getCsvPath() + 'Customers.csv');
    });

    it('9 Upload Products.csv',  () => {
        return csvFileUpload(testData.schema, testData.prod_tb,
            getCsvPath() + 'Products.csv');
    });

    it('10 Upload Orderdetails.csv',  () => {
        return csvFileUpload(testData.schema, testData.ordd_tb,
            getCsvPath() + 'Orderdetails.csv');
    });

    it('11 Upload Orders.csv',  () => {
        return csvFileUpload(testData.schema, testData.ords_tb,
            getCsvPath() + 'Orders.csv');
    });

    it('12 Upload Books.csv',  () => {
        return csvFileUpload(testData.schema_dev, 'books',
            getCsvPath() + 'Books.csv');
    });

    it('13 Upload BooksRatings.csv',  () => {
        return csvFileUpload(testData.schema_dev, 'ratings',
            getCsvPath() + 'BooksRatings.csv');
    });

    it('14 Upload movies.csv',  () => {
        return csvFileUpload(testData.schema_dev, 'movie',
            getCsvPath() + 'movies.csv');
    });

    it('15 Upload credits.csv',  () => {
        return csvFileUpload(testData.schema_dev, 'credits',
    ...
    it('CSV url load empty file',  () => {
        return csvUrlLoad(testData.schema, testData.csv_tb_empty,
    ...
    it('CSV file load bad attribute',  () => {
        return csvUrlLoad(testData.schema, testData.csv_tb_empty,
    ...
    it('Insert confirm dot & double data',  () => {
        return searchByHash(testData.schema_call, 'aggr', 'all',
    ...
    it('Insert attributes into DropAttributeTest',  () => {
        return insert(testData.schema_dev, 'AttributeDropTest',
          [
              {
                  hashid: 1,
    ...
    it('Insert confirm attributes added',  () => {
        return searchByHash(testData.schema_dev, 'AttributeDropTest',
          'hashid', [1, 2],
    ...
    it('csv_data_load with invalid attribute',  () => {
        return csvDataLoad(headers, 'insert', 'dev', 'invalid_attribute',
          'id,s/ome=attribute\n1,cheeseburger\n2,hamburger with cheese\n3,veggie burger\n',
          'Invalid column name \'s/ome=attribute\'');
    });

    it('csv_file_load with invalid attributes',  () => {
        return csvFileUpload(testData.schema_dev, 'invalid_attribute',
