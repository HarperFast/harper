...
it('Check Job Failed', async () => {
    const response = await request(envUrl)
        ...
        // Unmatched Postman assertion: const status = jsonData[0].status;
        // Unmatched Postman assertion:  // Unmatched Postman assertion: switch(status){
        // Unmatched Postman assertion: case 'ERROR':
        // Unmatched Postman assertion: console.log(jsonData[0])
        .expect((r) => assert.ok(r.body[0].message.includes('Invalid column name')))
...
// Unmatched Postman assertion: console.log('in progress, checking again')
    setTimeout(1000)
        // Unmatched Postman assertion: postman.setNextRequest('Check Job Failed')
        // Unmatched Postman assertion: break;
        // Unmatched Postman assertion: default:
        // Unmatched Postman assertion: postman.setNextRequest('Check Job Failed')
        // Unmatched Postman assertion: break;
        // Unmatched Postman assertion: }
        // Unmatched Postman assertion: //THIS MUST BE AT THE END!
        .expect((r) => assert.ok(r.status == 'IN_PROGRESS' || r.status == 'ERROR'))
});
