...
export class ReturnMatrix extends Resource {
  ...
  async get(query) {
    ...
    switch (c) {
      case 'plain-object':    return { value: 1, label: 'plain-object' };
      ...
      case 'promise-object':  return Promise.resolve({ value: 'from-promise' });
      default:                return { error: 'unknown case', case: c };
    }
  }
}
  ...
  async get(query) {
    ...
    switch (c) {
      ...
      case 'client-error-def':
        ...
        { const e = new Error('QA195 ClientError-unavailable fallback'); e.statusCode = 400; throw e; }

      case 'client-error-422':
        if (typeof ClientError !== 'undefined') {
          throw new ClientError('QA195 ClientError 422', 422);
        }
        { const e = new Error('QA195 ClientError-422 fallback'); e.statusCode = 422; throw e; }
  ...
  async post(query, data) {
    ...
    switch (c) {
      ...
      case 'client-error-def':
        ...
        { const e = new Error('QA195-POST ClientError fallback'); e.statusCode = 400; throw e; }
      case 'obj-statusCode':
  ...
  async put(query, data) {
    ...
    switch (c) {
      ...
      case 'client-error-def':
        ...
        { const e = new Error('QA195-PUT ClientError fallback'); e.statusCode = 400; throw e; }
      case 'obj-statusCode':
