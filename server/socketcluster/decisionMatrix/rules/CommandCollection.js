...
class CommandCollection {
	...
	addCommand(ruleIF_object) {
		...
		if (
			this.base.next &&
			ruleIF_object.command_order === types.COMMAND_EVAL_ORDER_ENUM.VERY_FIRST &&
			this.base.next.data.command_order === types.COMMAND_EVAL_ORDER_ENUM.VERY_FIRST
		) {
		...
		if (
			ruleIF_object.command_order === types.COMMAND_EVAL_ORDER_ENUM.VERY_LAST &&
			target_node.data.command_order === types.COMMAND_EVAL_ORDER_ENUM.VERY_LAST
		) {
