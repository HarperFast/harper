...
function configureSingleFunctionRoom(created_room) {
	...
	created_room.decision_matrix.removeRuleByType(
		types.RULE_TYPE_ENUM.ASSIGN_TO_HDB_WORKER,
		types.CONNECTOR_TYPE_ENUM.CORE,
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN
	);
	created_room.decision_matrix.removeRuleByType(
		types.RULE_TYPE_ENUM.ASSIGN_TO_HDB_WORKER,
	...
	created_room.decision_matrix.removeRuleByType(
		types.RULE_TYPE_ENUM.WRITE_TO_TRANSACTION_LOG,
		types.CONNECTOR_TYPE_ENUM.CORE,
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN
	);
	created_room.decision_matrix.removeRuleByType(
...
function configureWorkerRoom(created_room) {
	// Remove the AssignToHdbChildWorker rule.
	created_room.removeMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_OUT,
		types.PREMADE_MIDDLEWARE_TYPES.ORIGINATOR,
		types.CONNECTOR_TYPE_ENUM.CORE
	);
	created_room.removeMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_OUT,
	...
	created_room.decision_matrix.addRule(
		stripper,
		types.CONNECTOR_TYPE_ENUM.CLUSTER,
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN
	);
...
function configureCreateSchemaEntityRoom(created_room) {
	...
	created_room.decision_matrix.removeRuleByType(
		types.RULE_TYPE_ENUM.CLEAN_DATA_OBJECT,
		types.CONNECTOR_TYPE_ENUM.CORE,
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN
	);
	created_room.decision_matrix.removeRuleByType(
...
function configureStandardRoom(created_room) {
	...
	let subscribe_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_SUBSCRIBE,
		(req, next) => {
	...
	let out_auth_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_OUT,
		null,
	...
	let originator_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_OUT,
		null,
	...
	let stamp_originator_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_OUT,
		null,
	...
	let connection_name_check_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_OUT,
		null,
	...
	let msg_prep_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN,
		null,
	...
	let valid_data_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN,
		null,
	...
	let un_auth_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN,
		null,
		new middleware_factory.MiddlewareFactoryOptions(types.PREMADE_MIDDLEWARE_TYPES.AUTH)
	);
	...
	let stamp_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN,
		null,
	...
	let originator_in_middleware = middleware_factory.createMiddleware(
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN,
		null,
		new middleware_factory.MiddlewareFactoryOptions(types.PREMADE_MIDDLEWARE_TYPES.ORIGINATOR)
	);
	...
	new_decision_matrix.addRule(
		new AssignToHdbChildWorkerRule(),
		types.CONNECTOR_TYPE_ENUM.CLUSTER,
		types.MIDDLEWARE_TYPE.MIDDLEWARE_PUBLISH_IN
	);
	new_decision_matrix.addRule(
