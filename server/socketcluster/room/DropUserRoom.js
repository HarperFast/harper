...
/**
 * This is a room that handles messages on the hdb_internal:drop_user channel.  Rooms should not be instantiated directly, instead the room factory should be used.
 */
