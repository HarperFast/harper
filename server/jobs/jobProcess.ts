...
(async function job() {
	...
	try {
		...
		// get_job answers a refused bulk load with its structured permission report, the object a
		// direct refusal sends as its body, so keep the report rather than the error's text.
