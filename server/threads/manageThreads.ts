...
var threadTerminationTimeout = process.env.DEV_MODE === 'true' || process.env.DEV_MODE === '1' ? 30000 : 10000;
...
var EXTEND_SHUTDOWN_DEADLINE = 'extend-shutdown-deadline';
var getThreadInfo;
